...
# --- BARRA LATERAL: ARQUIVOS & NAVEGAÇÃO 100% VISÍVEL ---
...
if arquivo_atual:
    ...
    elif modulo_ativo == "4. Fila de Recuperação":
    ...
    # --- MÓDULO 5: AUDITORIA DE MALOTES ---
    elif modulo_ativo == "5. Auditoria de Malotes (Google Sheets)":
    ...
    # --- MÓDULO 6: COMPARADOR DE PLANILHAS ---
